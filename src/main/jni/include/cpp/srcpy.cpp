...
def EspUpdate(*_, **__):
    ...
    for entityId, entity in inst.entities.copy().items():
        ...
        if sync_attrs.get('bXray'): entity.model.UseTechHighLightXray(param=(1,0,0), param2=(0,0,0,0), color2=(1,1,1))
...
def AIMUpdate(*_, **__):
    ...
    Screen3_2 = Vector2(sync_attrs.get('fWidth', 2400) * 0.5, sync_attrs.get('fHeight', 1080) * 0.5)
    ...
    smoothing = 0.001 * sync_attrs.get('fAIM_SnapStrength', 0.1)
