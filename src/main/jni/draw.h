...
if (showMenu) {
    ...
    if (ImGui::Begin(OBFUSCATE("SpaceModz Safe Mod Menu"), &showMenu, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoBringToFrontOnFocus)) {
        ...
        if (ImGui::BeginTabBar("MainTabs", ImGuiTabBarFlags_FittingPolicyScroll)) {
            ...
            if (Settings::Tab == 1) { 
                ...
                ImGui::PushFont(G22);
                ImGui::TextColored(ImVec4(0, 1, 0.5f, 1), "Welcome to Space Modz Safe 100%");
                ImGui::PopFont();
                
                ImGui::Separator();   
                ImGui::TextColored(ImVec4(0.8f, 0.8f, 1.0f, 1.0f), "Developer Information:");
                ImGui::Indent(20);
                ImGui::BulletText("Seller: @fork0xf5");
                ImGui::BulletText("Version: Safe  v2.0");
                ImGui::BulletText("Build: Safe Edition");
                ImGui::Unindent(20);
            ...
            if (Settings::Tab == 5) { 
                ...
                ImGui::Text("Version");
                ImGui::TableNextColumn();
                ImGui::TextColored(ImVec4(0, 1, 1, 1), "v2.0 SAFE VERSION");
...
void __IMGUI__() {
    ...
    orig_getaddrinfo_type orig_getaddrinfo = (orig_getaddrinfo_type)dlsym(RTLD_NEXT, "getaddrinfo");
