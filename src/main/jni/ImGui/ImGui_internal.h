...
struct ImGuiContext
{
    ...
    ImGuiContext(ImFontAtlas* shared_font_atlas)
    {
        ...
        NavWindow = NULL;
        NavId = NavFocusScopeId = NavActivateId = NavActivateDownId = NavActivatePressedId = NavActivateInputId = NavInputId = 0;
...
//#endif
    ...
    ImGui_API void          RenderFrame2(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border = true, float rounding = 0.0f, bool border2 = false, ImColor out_col = ImColor(108, 108, 122));
    ...
    ImGui_API bool          ButtonEx(const char* label, bool selected);
