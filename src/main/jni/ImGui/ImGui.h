...
namespace ImGui
{
    ...
    ImGui_API void          WHITE123(ImGuiStyle* dst = NULL);
    ImGui_API void          GREEN123(ImGuiStyle* dst = NULL);
    ImGui_API void          YELLOW123(ImGuiStyle* dst = NULL);
    ImGui_API void          BLUE123(ImGuiStyle* dst = NULL);
   ...
   // ImGui_API bool          Button(const char* label, bool selected);   // button
   ImGui_API bool          ImGui_GOD_TAB(bool boolean, const char* icon, const char* label, const ImVec2& size_arg);
  ...
  //  ImGui_API bool          SliderScalar112(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format = NULL, ImGuiSliderFlags flags = 0);
   ...
   ImGui_API bool          IsKeyDown(int user_key_index);                                            // is key being held.
    ...
    bool VirtualInputEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data);
} // namespace ImGui
...
namespace Colors {
    ...
    inline ImVec4 TabFrameLeft;
    inline ImVec4 TabFrameRight;
