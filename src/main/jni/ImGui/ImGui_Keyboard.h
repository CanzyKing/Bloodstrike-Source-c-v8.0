...
ImVec2 window_size = ImVec2(io.DisplaySize.x, io.DisplaySize.y*0.5); // Screen width and desired height

SetNextWindowPos(window_pos, ImGuiCond_Appearing, ImVec2(0.0f, 0.0f));
SetNextWindowSize(window_size);
float original_scale = ImGui::GetIO().FontGlobalScale;
    if (BeginPopupModal(" Keyboard", NULL, ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoMove)) {
